...
def home(request):
    ...
    if request.method =="POST":
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=8C723CD4-3654-4534-87EA-F3061488BC47")
        try:
        ...
        return render(request,'lookup/home.html',{'api': api,'category_description':category_description,'category_color': category_color})


    else:
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=8C723CD4-3654-4534-87EA-F3061488BC47")
        try:
            api = json.loads(api_request.content)
        except Exception as e:
            api = "Error..."
